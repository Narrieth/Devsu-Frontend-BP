import { TErrorMsg } from "./error.interfaces";
...
export type TReplaceFieldByMsgError<T = unknown> = {
  [key in keyof T]: {
    [key in TErrorMsg]: string;
  }
}

export type TConfigErrorValidation<T = unknown> = {
  allHiddenFirstField?: boolean;
  allHiddenSecondField?: boolean;
  replaceFieldByMsgError?: TReplaceFieldByMsgError<T>
}

export interface IConfigGetAllWithConfigError<T> extends IConfigGetAll, TConfigErrorValidation {}
